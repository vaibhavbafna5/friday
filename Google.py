...
class GoogleAssistant:
    ...
    def __init__(self):
        ...
        self.client = SampleTextAssistant(lang, device_model_id, device_id, display,
                            grpc_channel, grpc_deadline)

        print("Google Assistant booted successfully")


    def ask_assistant_query(self, query):
        with self.client:
            response_text, response_html = self.client.assist(text_query=query)
